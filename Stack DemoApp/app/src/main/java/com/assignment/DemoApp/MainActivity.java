package com.assignment.DemoApp;
...
import com.assignment.DemoApp.Adapter.Adapter_Emi;
import com.assignment.DemoApp.Entity.Emi;
...
public class MainActivity extends AppCompatActivity implements Adapter_Emi.InterfaceEmi, CircularSeekBar.OnCircularSeekBarChangeListener {
    ...
    private void getEmiPlans() {
        ...
        pojoEmiArrayList.add(new Emi("₹5,000", "for 12 months", R.color.vintageBlue, true));
        pojoEmiArrayList.add(new Emi("₹7,000", "for 9 months", R.color.vintageBrown, false));
        pojoEmiArrayList.add(new Emi("₹9,000", "for 6 months", R.color.vintageViolet, false));
        pojoEmiArrayList.add(new Emi("₹12,000", "for 4 months", R.color.vintageBlue, false));
    }
